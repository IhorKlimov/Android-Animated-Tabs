...
class SmartTabStrip extends LinearLayout {
  ...
  private boolean indicatorAlwaysAtStart;
  ...
  SmartTabStrip(Context context, AttributeSet attrs) {
    ...
    indicatorAlwaysAtStart = a.getBoolean(
            R.styleable.stl_SmartTabLayout_stl_indicatorAlwaysAtStart, indicatorAlwaysAtStart);
  ...
  boolean isIndicatorAlwaysAtStart() {
    return indicatorAlwaysAtStart;
  }
